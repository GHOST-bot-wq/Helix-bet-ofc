  ...
  fetch('/api/public/config?_=' + Date.now())
    ...
    .then(cfg => {
      if (cfg.registro_aberto === false) {
        ...
        warn.style.cssText = 'background:rgba(255,77,109,.12);border:1px solid rgba(255,77,109,.3);border-radius:10px;padding:12px 14px;font-size:13px;color:#fca5a5;text-align:center;margin-top:12px';
